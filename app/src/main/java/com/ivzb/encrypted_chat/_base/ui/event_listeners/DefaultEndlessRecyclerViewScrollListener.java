package com.ivzb.encrypted_chat._base.ui.event_listeners;
...
public abstract class DefaultEndlessRecyclerViewScrollListener extends RecyclerView.OnScrollListener {
    ...
    public DefaultEndlessRecyclerViewScrollListener(LinearLayoutManager layoutManager) {
        this.mLayoutManager = layoutManager;
    }

    public DefaultEndlessRecyclerViewScrollListener(LinearLayoutManager layoutManager, int startingPageIndex) {
        this(layoutManager);
